...
class MediaGridCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        videoIndicator.frame = CGRect(
            x: bounds.size.width - videoIndicatorImage.size.width - videoIndicatorPadding,
            y: bounds.size.height - videoIndicatorImage.size.height - videoIndicatorPadding,
